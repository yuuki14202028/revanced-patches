package com.github.yuuki14202028.patches.example.hook.json
...
import com.github.yuuki14202028.patches.example.hook.json.fingerprints.JsonHookPatchFingerprint
import com.github.yuuki14202028.patches.example.hook.json.fingerprints.JsonInputStreamFingerprint
import com.github.yuuki14202028.patches.example.hook.json.fingerprints.LoganSquareFingerprint
...
object JsonHookPatch : BytecodePatch(
    ...
    Hook(context: BytecodeContext, internal val descriptor: String) {
        ...
        init {
            ...
            } ?: throw ClassNotFoundException("Failed to find hook class in ${context.classes.filter { it.type.startsWith("Lapp/revanced/twitter/patches/hook/patch") }.map { c -> c.type }}")
        }
    }
