package com.github.yuuki14202028.patches.example.hook.patch.blue
...
@Patch(
    name = "Hide blue",
    description = "Hides blue.",
    dependencies = [JsonHookPatch::class],
    compatiblePackages = [CompatiblePackage("com.twitter.android")]
)
@Suppress("unused")
object HideBluePatch : BaseHookPatchPatch("Lapp/revanced/twitter/patches/hook/patch/blue/BlueHook;")